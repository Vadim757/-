...
public class Main {
    ...
    public Main(String fp, String sp) {
        this.fp = new Stack<>();
        this.sp = new Stack<>();
        for(int i = 4; i >= 0; i --){
    ...
    public static void main(String[] args) {
        System.out.println(new Main("13579", "24680").play());
        System.out.println(new Main("12345", "67890").play());
        System.out.println(new Main("13029", "42685").play());
    }
}
